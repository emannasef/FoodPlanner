...
public class MondayAdapter extends RecyclerView.Adapter<MondayAdapter.ViewHolder> {
    ...
    private List<MealPlan> mondayMeals;
    OnDayClickListener onDayClickListener;

    public void setMondayList(List<MealPlan> updatedMondayMeals)
    {
        this.mondayMeals = updatedMondayMeals;
    }

    public MondayAdapter(Context context, OnDayClickListener onDayClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MondayAdapter.ViewHolder myViewHolder = new MondayAdapter.ViewHolder(v);
        return  myViewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        MealPlan mealPlan=mondayMeals.get(position);
        Glide.with(context)
                .load(mondayMeals.get(position).strMealThumb)
        ...
        holder.mealNameTextView.setText(mondayMeals.get(position).strMeal);
